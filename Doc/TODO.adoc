...
. Create a class diagram on Papyrus according to the existing file https://github.com/oliviercailloux-org/projet-assisted-board-games-1/blob/main/Doc/Architecture.png[Architecture.png] and update its references on the documentation.
