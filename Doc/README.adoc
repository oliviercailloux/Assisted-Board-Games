...
== The mechanics of the games
 ...
 - https://github.com/oliviercailloux-org/projet-assisted-board-games-1/blob/ABG-Tache33/Doc/Chess diagrams Basics.adoc#play-chess-diagram[Play chess]
 - https://github.com/oliviercailloux-org/projet-assisted-board-games-1/blob/ABG-Tache33/Doc/Chess diagrams Basics.adoc#record-chess-move-diagram[Record Chess Move]
...
== The user interface
 - https://github.com/oliviercailloux-org/projet-assisted-board-games-1/blob/ABG-Tache33/Doc/Chess diagrams Basics.adoc#record-chess-move-graphically-diagram[Record Chess Move Graphically]
