...
class CheckersTests {
  @Test
  void testSquare() {
    assertThrows(IllegalArgumentException.class, () -> Square.given(-15),
        "Expected to throw IllegalArgument exception, but it didn't");
    assertThrows(IllegalArgumentException.class, () -> Square.given(0),
        "Expected to throw IllegalArgument exception, but it didn't");
    assertThrows(IllegalArgumentException.class, () -> Square.given(51),
        "Expected to throw IllegalArgument exception, but it didn't");
    assertEquals(1, Square.given(1).getSquareNumber(),
        "Actual square number doesn't match expected one");
    assertEquals(50, Square.given(50).getSquareNumber(),
        "Actual square number doesn't match expected one");
  ...
  @Test
  void testPiece() {
    assertThrows(IllegalArgumentException.class, () -> Piece.given(null, null),
        "Expected to throw IllegalArgument exception, but it didn't");
    assertThrows(IllegalArgumentException.class, () -> Piece.given(PieceSort.NORMAL_PIECE, null),
        "Expected to throw IllegalArgument exception, but it didn't");
    assertThrows(IllegalArgumentException.class, () -> Piece.given(null, Side.WHITE),
        "Expected to throw IllegalArgument exception, but it didn't");

    assertEquals(Piece.given(PieceSort.NORMAL_PIECE, Side.WHITE),
        Piece.given(PieceSort.NORMAL_PIECE, Side.WHITE));
    assertNotEquals(Piece.given(PieceSort.NORMAL_PIECE, Side.BLACK),
        Piece.given(PieceSort.NORMAL_PIECE, Side.WHITE));
    assertNotEquals(Piece.given(PieceSort.QUEEN, Side.WHITE),
        Piece.given(PieceSort.NORMAL_PIECE, Side.WHITE));

    assertEquals(Piece.given(PieceSort.NORMAL_PIECE, Side.WHITE).hashCode(),
        Piece.given(PieceSort.NORMAL_PIECE, Side.WHITE).hashCode());
    assertNotEquals(Piece.given(PieceSort.NORMAL_PIECE, Side.BLACK).hashCode(),
        Piece.given(PieceSort.NORMAL_PIECE, Side.WHITE).hashCode());
    assertNotEquals(Piece.given(PieceSort.QUEEN, Side.WHITE).hashCode(),
        Piece.given(PieceSort.NORMAL_PIECE, Side.WHITE).hashCode());
    ...
    assertEquals("Piece{color=BLACK, sort=NORMAL_PIECE}",
        Piece.given(PieceSort.NORMAL_PIECE, Side.BLACK).toString());
  }
  ...
  void testCheckerBoard() {
    ...
    assertThrows(NullPointerException.class, () -> CheckerBoard.given(null),
        "Expected to throw NullPointerException exception, but it didn't");
    assertThrows(NullPointerException.class, () -> board.getPiece(null),
        "Expected to throw NullPointerException exception, but it didn't");
  }
  ...
  void testCheckerBoardMove() {
    ...
    assertThrows(NullPointerException.class, () -> board.move(null, Square.given(23)),
        "Expected to throw NullPointerException exception, but it didn't");
    assertThrows(NullPointerException.class, () -> board.move(Square.given(34), null),
        "Expected to throw NullPointerException exception, but it didn't");
    assertThrows(IllegalStateException.class, () -> board.move(Square.given(1), Square.given(5)),
        "Expected to throw IllegalStateException exception, but it didn't");
    assertThrows(IllegalStateException.class, () -> board.move(Square.given(21), Square.given(26)),
        "Expected to throw IllegalStateException exception, but it didn't");
    assertThrows(IllegalStateException.class, () -> board.move(Square.given(27), Square.given(32)),
        "Expected to throw IllegalStateException exception, but it didn't");
    assertThrows(IllegalStateException.class, () -> board.move(Square.given(1), Square.given(7)),
        "Expected to throw IllegalStateException exception, but it didn't");

    Square s1 = Square.given(5);
    Square s2 = Square.given(5);
    assertThrows(IllegalArgumentException.class, () -> board.move(s1, s1),
        "Expected to throw IllegalArgumentException exception, but it didn't");
    assertThrows(IllegalArgumentException.class, () -> board.move(s1, s2),
        "Expected to throw IllegalArgumentException exception, but it didn't");
    ...
    final Map<Square, Piece> inputMap =
        Map.of(Square.given(1), Piece.black(), Square.given(2), Piece.black(), Square.given(3),
            Piece.black(), Square.given(33), Piece.white(), Square.given(34), Piece.white());
