...
public class GameDAO implements Serializable {
  ...
  private GameDAO(Instant startTime, Duration clockDuration, Duration clockIncrement,
      String position, List<MoveDAO> moves) {
  ...
  public static GameDAO createGameDAO(@JsonbProperty("startTime") Instant startTime,
      ...
      @JsonbProperty("position") String position, @JsonbProperty("moves") List<MoveDAO> moves) {
  ...
  public GameEntity asGameEntity() {
    ...
    final GameEntity gameEntity =
        new GameEntity(gameState, startTime, clockDuration, clockIncrement);
