...
public class Move {
	 ...
	 * <p>
	 * to: where the piece is being promoted to
	 * from: where the piece is being promoted from
	 * <p>
	...
	/**
	 * <p>
	 * Checks that the start and finish squares are not null
	 * if the piece is null, then a new piece is initialized
	 */
