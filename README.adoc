...
== *Description for iteration UML#6 - Project leader: Kerim HUDAYBERDIYEV*


=== *Yasmine HAMNACHE & Dahuiss AMOUSSOU, Tasks : Correction of the class diagrams of "GameEntity", "GameState" classes and correction of the sequence diagram of "CheckerBoard" class*

*[1]* - Correction of the class diagrams of "GameEntity" and "GameState", which were initially proposed by Marina ATANGANA & James BURTON (cf. : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/44[PR 44]), by taking into account the observations and comments on https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/44[Pull request #44], which contains the initial proposal of documentation for `GameEntity` and `GameState` classes implemented in JAVA.

*[2]* - Correction of the sequence diagram of "CheckerBoard", which was initially proposed by Dahuiss AMOUSSOU & Anam SHAIKH YUNUS (cf. : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/47[PR 47]), by taking into account the observations and comments on https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/47[Pull request #47], which contains the initial proposal of sequence diagram for `CheckerBoard` class.

=== *Aaron DEMAY & Anam SHAIKH YUNUS, Tasks : Correction of the class diagram of "CheckerBoard" class and correction of the sequence diagram of "PlayerState" class*

*[1]* - Correction of the class diagram of "CheckerBoard", which was initially proposed by Aaron DEMAY & Kerim HUDAYBERDIYEV (cf. : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/40[PR 40]), by taking into account the observations and comments on https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/40[Pull request #40], which contains the initial proposal of class diagram for `CheckerBoard` class. The JAVA implementation and associated discussions of the mentioned diagram can be found on https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/49[PR 49].

*[2]* - Resolving the issue https://github.com/oliviercailloux-org/projet-assisted-board-games-1/issues/42[#42]. Correction of the sequence diagram of "PlayerState", which was initially proposed by Kerim HUDAYBERDIYEV & Dahuiss AMOUSSOU (cf. : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/27[PR 27]), by taking into account the observations, comments and removing the duplicates.

=== *Marina ATANGANA & James BURTON, Tasks : Re-creation of "CheckerBoard", "GameEntity" and "GameState" class diagrams, "Player options" use case diagram and of "CheckerBoard" sequence diagram*

*[1]* - Re-implementation of the approved "CheckerBoard" (cf. : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/40[PR 40]) class diagram  in order to have only 1 unique version of the Papyrus model and hence eliminating the possible conflicts when merging with the main branch.

*[2]* - Re-implementation of the approved "GameEntity" and "GameState" (cf. : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/44[PR 44]) class diagram  in order to have only 1 unique version of the Papyrus model and hence eliminating the possible conflicts when merging with the main branch.

*[3]* - Re-implementation of the approved "Player options" (cf. : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/45[PR 45]) use case diagram  in order to have only 1 unique version of the Papyrus model and hence eliminating the possible conflicts when merging with the main branch.

*[4]* - Re-implementation of the approved "CheckerBoard" (cf. : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/47[PR 47]) sequence diagram  in order to have only 1 unique version of the Papyrus model and hence eliminating the possible conflicts when merging with the main branch.


== *Description for iteration JAVA#4 - Project leader: Dahuiss AMOUSSOU*


=== *Kerim HUDAYBERDIYEV  & Yasmine HAMNACHE, Tasks :*
- Task 1 : Improvement of the classes :  `CheckerBoard`, `Square` and `Piece`  taking into account the remarks of the https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/49[PR 49].
- Task 2 : Improvement of the game clock proposition, based on your suggestion on the https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/35[PR 35]

=== *Aaron DEMAY & Marina ATANGANA, Task:*
- Creation of the methods of suggestions of moves of Checkers's game in `Move` class. 

=== *Anam SHAIKH YUNUS & James BURTON, Task:*
- Creation of a `Move` class. The main idea is to set up a class that describes a movement in the checkers game. We will based on the existing MoveEntity class for the chess game to implement our class.
