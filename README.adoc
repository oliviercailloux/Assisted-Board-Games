...
=== *Yasmine HAMNACHE & Dahuiss AMOUSSOU, Task : Correction of the class diagrams of "GameEntity", "GameState" classes and correction of the sequence diagram of "CheckerBoard" class*
...
=== *Aaron DEMAY & Anam SHAIKH YUNUS, Task : Correction of the class diagram of "CheckerBoard" class and correction of the sequence diagram of "PlayerState" class*
...
*[2]* Resolving the issue https://github.com/oliviercailloux-org/projet-assisted-board-games-1/issues/42[#42]. Correction of the sequence diagram of "PlayerState", which was initially proposed by Kerim HUDAYBERDIYEV & Dahuiss AMOUSSOU (cf. : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/27[PR 27]), by taking into account the observations and comments and removing the duplicates.

=== *Marina ATANGANA & James BURTON, Task : Re-creation of all the existing and approved diagrams*

Re-implementation of the approved diagrams to have only 1 unique version of the Papyrus model and hence eliminating the possible conflicts in the future when merging with the main branch. Useful discussions : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/47[Pr 47], https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/45[PR 45], https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/44[PR 44] and https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/40[PR 40].
