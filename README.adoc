...
- *Tache 1 : Mise à jour des méthodes HTTP utilisées*

- *Tache 2 : Fournir une liste correcte des coups joués lors d'une partie*

- *Tache 3 : Création d'un modèle pour les puzzles*

- *Tache 4 : Ajout d'un aide visuelle aux coups* (surbrillance des cases possibles pour la pièce sélectionnée)
