...
- Creation of a `Move` class. The main idea is to set up a class that describes the possible movements. We will based on the implementation of the class the MoveEntity existing class of chess game.
