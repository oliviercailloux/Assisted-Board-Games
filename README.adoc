...
*[1]* - Re-implementation of the approved "CheckerBoard" (cf. : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/40[PR 40]) diagram  in order to have only 1 unique version of the Papyrus model and hence eliminating the possible conflicts when merging with the main branch.

*[2]* - Re-implementation of the approved "CheckerBoard" (cf. : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/44[PR 44]) diagram  in order to have only 1 unique version of the Papyrus model and hence eliminating the possible conflicts when merging with the main branch.

*[3]* - Re-implementation of the approved "CheckerBoard" (cf. : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/45[PR 45]) diagram  in order to have only 1 unique version of the Papyrus model and hence eliminating the possible conflicts when merging with the main branch.

*[4]* - Re-implementation of the approved "CheckerBoard" (cf. : https://github.com/oliviercailloux-org/projet-assisted-board-games-1/pull/47[PR 47]) diagram  in order to have only 1 unique version of the Papyrus model and hence eliminating the possible conflicts when merging with the main branch.
