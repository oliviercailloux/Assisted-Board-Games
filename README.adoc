...
- Creation of a `Move` class. The main idea is to set up a class that describes a movement. We will based on the existing MoveEntity class for the chess game to implement our class.
