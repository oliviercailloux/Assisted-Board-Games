...
- Creation of a `Move` class. The main idea is to set up a class that describes a movement. We will based on the implementation of the class the MoveEntity existing class of chess game.
