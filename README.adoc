...
Implementation pf the Piece class which represents a piece of the game of Checkers or Chess. This one will have a color and a boolean attribute which indicates if it is promoted. 

Implementation of the Square class chich represents the squares of a chessboard or a checkerboard through coordinates (vertical and horizontal).
